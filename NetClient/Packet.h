...
#pragma warning(default : 26495)
	...
	friend void NetClient::RecvProc(Session* pSession, int numberOfBytesTransferred);
	friend BOOL NetClient::SendPost(Session* pSession);
	friend void NetClient::SendProc(Session* pSession, DWORD dwNumberOfBytesTransferred);
	friend void NetClient::ReleaseSession(Session* pSession);
};
